  ...
  try {
    switch (resourceType) {
      case 'room':
        ...
        return room?.nguoi_dung_id === userId;
      ...
      case 'feeType':
        ...
        return feeType?.nguoi_dung_id === userId;

      case 'utilityRate':
        const utilityRate = await prisma.pRP_DON_GIA_DIEN_NUOC.findUnique({
          where: { id: resourceId },
          select: { nguoi_dung_id: true }
        });
        return utilityRate?.nguoi_dung_id === userId;
