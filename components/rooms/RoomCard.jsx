...
export default function RoomCard({
  ...
  const statusColors = {
    TRONG: "bg-muted text-muted-foreground",
    DA_THUE: "bg-primary text-primary-foreground",
  };
        ...
        <CardHeader className="pb-3">
          <div className="flex justify-between items-start gap-2">
            <div className="flex-1 min-w-0">
              ...
              >
                <CardTitle className="text-lg sm:text-xl font-bold wrap-break-word">
                  {room.ma_phong}
                </CardTitle>
            ...
            <div className="flex flex-col items-end gap-2 shrink-0">
              <span
                className={`px-3 py-1.5 rounded-full text-sm font-medium ${statusColors[room.trang_thai]}`}
              >
            ...
            <div className="min-h-12">
              {room.ngay_chot_so ? (
                ...
                <div>
                  ...
                  <p className="text-base font-medium">Chưa cấu hình</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {onConfigureUtilityRates ? (
                ...
                <Button
                  ...
                  disabled={room.trang_thai === "DA_THUE"}
                  title={
                    room.trang_thai === "DA_THUE"
