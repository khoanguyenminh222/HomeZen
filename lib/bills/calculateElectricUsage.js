/**
 * Tính điện tiêu thụ và phát hiện xoay vòng đồng hồ
 * 
 ...
 */
export function calculateElectricUsage(oldReading, newReading, maxMeter = 999999) {
  ...
  if (rollover) {
    ...
    // Ví dụ: cũ = 999990, mới = 10 => tiêu thụ = (maxMeter - oldReading) + newReading
