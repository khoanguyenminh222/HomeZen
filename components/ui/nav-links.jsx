...
const NavigationMenuList = React.forwardRef(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "group flex flex-1 list-none items-center justify-center lg:justify-start gap-1",
      className,
    )}
    {...props}
  />
...
const NavigationMenuContent = React.forwardRef(
  ({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.Content
      ref={ref}
      className={cn(
        "absolute top-full mt-1.5 w-auto rounded-md border bg-popover text-popover-foreground shadow-lg focus:outline-none",
...
// Viewport removed to support inline rendering for better alignment
...
const superAdminNavItems = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        href: "/admin/reporting/permissions",
    ...
    : item.href &&
      (pathname === item.href ||
        (item.href !== "/" &&
          ...
          (item.href === "/bills"
            ? pathname?.startsWith("/bills") && pathname !== "/bills/history"
            : // Nếu href là /admin/reporting, chỉ active khi pathname chính xác là /admin/reporting
              item.href === "/admin/reporting"
...
export function NavLinks() {
  ...
  const isSuperAdmin =
    status === "authenticated" && session?.user?.vai_tro === "SIEU_QUAN_TRI";
            ...
            >
              <div className="flex flex-col h-full min-h-full bg-card shadow-none border-none">
                ...
                <div className="relative px-6 py-4 border-b border-border/50 bg-card shrink-0">
                  ...
                  {/* User Info Section */}
                  {shouldShowUserInfo ? (
                    status === "authenticated" && session?.user?.tai_khoan ? (
                      <div className="pr-12">
                        <div className="flex items-center gap-3">
                          <div
                            className={cn(
                              "flex items-center justify-center w-12 h-12 rounded-xl shrink-0",
                              session.user.vai_tro === "SIEU_QUAN_TRI"
                                ? "bg-primary/20 text-primary"
