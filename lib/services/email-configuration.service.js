    ...
    try {
      ...
      const mailOptions = {
        from: validatedConfig.fromName 
          ...
          : fromEmail,
        to: testEmail,
        subject: 'Email Test từ HomeZen',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #333;">Email Test Thành Công!</h2>
            <p>Xin chào,</p>
            <p>Đây là email test từ hệ thống HomeZen. Nếu bạn nhận được email này, có nghĩa là cấu hình SMTP của bạn đã hoạt động chính xác.</p>
            ...
            <p style="color: #666; font-size: 12px; margin-top: 30px;">
              Email này được gửi tự động từ hệ thống HomeZen để kiểm tra cấu hình email.
            </p>
          </div>
        `,
        text: `
...
Đây là email test từ hệ thống HomeZen. Nếu bạn nhận được email này, có nghĩa là cấu hình SMTP của bạn đã hoạt động chính xác.
